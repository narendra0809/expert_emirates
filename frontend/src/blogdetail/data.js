...
export const cardsData = [
  {
    ...
    content:
      "PENDLEUSDT is preparing for distribution after a prolonged consolidation. The price is testing a key resistance level, which, if broken, will trigger a rally..",
