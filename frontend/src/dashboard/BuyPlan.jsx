  ...
  return (
    <main className="p-4">
      <div className="flex flex-col lg:flex-row gap-6 text-white min-h-screen">
        {/* Left: Buy New Plan */}
        <div className="md:ml-12 flex-1 bg-[#121117] p-6 rounded-2xl flex flex-col">
          ...
          <div className="mt-10 bg-[#121117] border border-[#1D1B25] shadow-[0px_0px_10px_0px_rgba(145,158,171,0.20)] outline outline-1 outline-offset-[-1px] outline-[#1D1B25] p-6 rounded-md flex-1 flex flex-col">
            <div className="space-y-6 flex-1">
              <div className="space-y-4 relative">
                ...
                <select className="w-full bg-[#121117] border border-gray-700 text-gray-700 py-3 pl-3 pr-8 rounded focus:outline-none focus:ring-1 focus:ring-yellow-500 appearance-none">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 bg-[#121117] p-3 rounded-md">
                  {["ETH ERC20", "USDT TRC20", "Bank Transfer", "BTC"].map(
                    (method) => (
                      <div
                        key={method}
            ...
            <button className="w-full bg-gradient-to-l from-[#452e06] via-[#d1bf5a] via-50% to-[#452e06] text-black px-6 py-3 text-sm sm:text-base rounded-full shadow-md hover:brightness-110 transition-all duration-300 mt-6">
              PROCEED TO PAYMENT
            </button>
          </div>
        </div>
