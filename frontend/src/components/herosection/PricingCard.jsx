...
const PricingCard = () => {
  return (
    <div className="xl:w-[620px] lg:w-[320px] md:w-[350px] w-full h-[350px]  flex justify-start items-center py-8  sm:px-4 px-0">
      <div className="group relative  h-[360px] flex justify-center items-center py-3 px-4">
        <div
        ...
        >
          ...
          <div className="relative z-10 text-white text-left  lg:py-6">
            ...
            <p className="text-sm md:text-base mt-4 text-white leading-relaxed">
              YOUR TRADING DESERVES THE BEST — DISCOVER OUR ULTRA-LOW PRICING,
              TRUSTED BY PROFESSIONALS IN FOREX, GOLD & CRYPTO".
            </p>
            ...
            <div className="flex sm:mt-10 mt-16">
              <div className="p-[2px] rounded-full bg-[linear-gradient(90deg,#281000_0%,#C0971C_25.5%,#FFE976_49.5%,#C0971C_74.5%,#281000_100%)]">
                <button
                  onClick={() =>
                    document
                      .getElementById("sample-plans")
                      .scrollIntoView({ behavior: "smooth" })
                  }
                  className="w-[130px] h-[52px] rounded-full bg-black text-white text-sm font-medium tracking-wider relative overflow-hidden transition-all duration-500 hover:text-black hover:bg-[linear-gradient(90deg,#281000,#C0971C,#FFE976,#C0971C,#281000)]"
                >
