...
import DefaultAvatar from "../assets/starticon.png";
...
export default function AdminSettings() {
  ...
  return (
    <>
      {/* Main Content */}
      <div className="flex-1 flex flex-col  overflow-y-scroll hide-scrollbar">
              ...
              <div className="flex flex-col lg:flex-row gap-4 md:gap-6 lg:gap-8">
                ...
                <div className="w-full lg:w-[32%] text-center bg-[#121117] p-4 rounded-xl border border-[#29272e]">
                  ...
                  <p className="text-xs text-gray-500 mt-3">
                    Allowed *.jpeg, *.jpg, *.png, *.gif <br /> Max size of 3.1
                    MB
                  </p>
