export default function MarketSection() {
  return (
    <section
      id="market_section"
      className="bg-black text-white w-full px-4 sm:px-6 lg:px-8 py-16 text-center font-[Poppins]"
    >
      {/* Button */}
      <div className="mb-6">
      ...
      <p className="text-[18px] leading-[32px] max-w-4xl mx-auto text-gray-300 tracking-[0.03em]">
        Step into the world of professional trading with our comprehensive suite
        of financial services. We combine cutting-edge technology with expert
        market knowledge to give you an edge in today’s dynamic markets.
      </p>
    </section>
  );
}
